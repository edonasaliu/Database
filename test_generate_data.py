import unittest
import sqlite3
from generate_data import num_users, num_workouts_per_user, num_exercises_per_workout, num_logs_per_user, num_meals_per_log, num_records_per_user, num_metrics_per_user
...
class TestGenerateData(unittest.TestCase):
    ...
    def test_generate_data(self):
        ...
        from generate_data import fake, conn, cursor

        # Call the function to generate data and insert it into the database
